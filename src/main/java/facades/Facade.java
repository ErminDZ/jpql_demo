...
public class Facade implements IFacade {
    ...
    public Employee update(Employee e) {
        EntityManager em = emf.createEntityManager();
        Employee found = em.find(Employee.class,e.getId());// henter employees id fra databasen
        String name = e.getName(); // Det nye navn
        if (name != null){
            found.setName(name);// her bliver den navnet fra databasen erstattet med det nye navn
        }
        try {
